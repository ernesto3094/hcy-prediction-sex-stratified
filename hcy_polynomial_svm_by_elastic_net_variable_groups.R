...
importance_table <- tibble(
  Variable = c(
    "COL", "LDLHDLIndice", "IMCCat", "GrasaVisCat", "Hto", "IMC",
    "Talla", "RDWCV", "VCM", "AIP", "Hgb", "HDL", "MCH", "PLT",
    "Edad", "Peso", "GrasaT", "Musculo", "MetabBasal", "GrasaVisc",
    "MCHC", "RBC", "WBC", "GLU", "TRG", "LDL", "VLDL",
    "ColHDLIndice", "LCI"
  ),
  Overall = c(
    100.000000, 87.702454, 79.590836, 53.070248, 43.398385, 42.192621,
    26.707153, 21.233310, 16.643293, 16.309048, 7.184331, 6.433470,
    3.265729, 1.033542, 0.000000, 0.000000, 0.000000, 0.000000,
