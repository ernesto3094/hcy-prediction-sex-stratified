...
# Full eligible predictors - Female subgroup
#
# - Original-scale HCY
# - No transformation
# - No centering
...
# - Variable importance
# - Learning curves
# - Excel and figures exported to the previous women XGBoost folder
# ============================================================
...
# Same route used in the previous women XGBoost code
output_dir <- "results/women/xgboost"
...
# This is similar in size to the second tuning used for men.
